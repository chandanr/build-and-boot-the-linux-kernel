...
% 4. uname -a (Chandan)
% 5. System.map (Vasant)
% 6. Initramfs/initrd. (Chandan)
% 7. vmlinuz v/s vmlinux (Chandan)
...
\begin{frame}
  % DONE: TODO: Add software stack diagram and highlight Linux kernel component
  \center {
  \begin{tikzpicture}
...
% DONE: TODO: Mention that the build is for system currently running.
\end{itemize}
...
% TODO: Mention about the ability to search through config information.
...
\begin{frame}
  ...
  \item \texttt{printk()} dumps its contents to a ring buffer maintained by
    the kernel.
    % TODO: Add an example invocation.
  \end{itemize}
\end{frame}

% TODO: Talk about levels.
\begin{frame}
  \begin{itemize}
...
\section{Assignment}
% TODO: Explain what "uname" command does.
\begin{frame}
